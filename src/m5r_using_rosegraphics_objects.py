...
#            It is necessary when the window is intended to stay open after
#           completing all actions. If the method is not called, the window
#           will close immediately after all actions done.
#
